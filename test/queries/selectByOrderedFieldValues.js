...
describe('QUERY selectByOrderedFieldValues', () => {
    it('should generate sql and parameter for select entity by given selector list', () => {
        const selectQuery = selectByOrderedFieldValuesQuerier('table', 'id', ['fielda', 'fieldb']);
