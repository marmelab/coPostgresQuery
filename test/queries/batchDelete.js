...
describe('QUERY batchDelete', function () {
    it('should generate sql and parameter to batchDelete given single ids', function () {
    ...
    it('should generate sql and parameter to batchDelete given multikey ids', function () {
