...
export default function ({ table, fields, idFields, returnFields = fields, updatableFields = fields }) {
    ...
    const updateOne = updateOneQuery({ table, updatableFields, idFields, returnFields });
